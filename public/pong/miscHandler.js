...
export class miscHandler {
    ...
    createCamera() {
        ...
        const animationWalk3 = new BABYLON.Animation("moveAlongPath", "position", frameRate, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
