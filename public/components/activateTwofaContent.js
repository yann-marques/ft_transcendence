...
import { toggleElt, toggleErrorText, updateStatus, verifyQRCode } from "../utils.js";
let activateTwofaContent = class activateTwofaContent {
    constructor() {
...
activateTwofaContent = __decorate([
    Component({
        template: () => /* html */ `
    <div class="flex flex-col gap-5 w-full px-4">
        
        <div id="activate2faContent" class="flex flex-col hidden invisible w-full h-full items-center justify-center gap-8">
            <div class="flex flex-col justify-center items-center text-center gap-4">
                <img class="w-[150px] h-[150px]" id="QRCode" src="" />
                <h1 class="flex text-white">Scanner le QR code avec une app 2FA pour recevoir le code de validation</h1>
...
], activateTwofaContent);
export { activateTwofaContent };
