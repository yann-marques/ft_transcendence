...
let twofaContent = class twofaContent {
    constructor() {
...
twofaContent = __decorate([
    Component({
        template: html `
    <div class="flex flex-col gap-5 w-full px-4">
        
        <div id="2faContent" class="flex flex-col hidden invisible w-full h-full items-center justify-center gap-8">
