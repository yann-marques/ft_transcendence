...
import { toggleErrorText, toggleProfileContent, toggleProfileQRCode, updateStatus, verifyQRCode } from "../utils";
const html = String.raw;
let twofaPopup = class twofaPopup {
    constructor() {
...
twofaPopup = __decorate([
    Component({
        template: html `
    <div class="flex flex-col gap-5 w-full px-4">
        
        <div id="popupQRCode" class="flex flex-col hidden invisible w-full h-full items-center justify-center gap-8">
