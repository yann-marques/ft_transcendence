...
type ballinfo = {mesh: any, aggr: BABYLON.PhysicsAggregate, speed: number, lastTouched: pdlinfo, bounces: number}
...
export class meshHandler
{
	...
	public	hk				:	BABYLON.HavokPlugin;
	public	removeEvents	:	Function;
	public	deleteScene		:	boolean = false;
	public	sceneStopped	:	boolean = false;

	public	WIDTH			:	number = 100;
	public	HEIGHT			:	number = 50;
	public	DEPTH			:	number = 1;
	public	UP_WALL			:	number = 0;
	public	DOWN_WALL		:	number = 1;
	public	LEFT_WALL		:	number = 2;
	public	RIGHT_WALL		:	number = 3;
	public	FLOOR_WALL		:	number = 4;
	public	DEPTH_FLOOR		:	number = 100;
	public	TOUCH_GROUND3D	:	number = -(this.HEIGHT + 3) / 2;

	public	DIAMETER		:	number = 1.25;
	public	SEGMENTS		:	number = 16;
	
	public	WIDTH_PA		:	number = 0.5;
	public	HEIGHT_PA		:	number = 7;
	public	DEPTH_PA		:	number = 1;

	public	startSpeed		:	number = 60;

	public	score_p1		:	number = 0;
	public	score_p2		:	number = 0;
	public	is_goal_scored	:	boolean = false;
	public	score_mesh_l	:	BABYLON.Mesh;
	public	score_mesh_r	:	BABYLON.Mesh;
	public 	txt_score_r		:	BABYLON.GUI;
	public 	txt_score_l		:	BABYLON.GUI;

	public	window			:	objinfo;
	public	Walls			:	{up: objinfo, down: objinfo, left: objinfo, right: objinfo, floor: objinfo} = {up: { mesh: null, aggr: null }, down: { mesh: null, aggr: null }, left: { mesh: null, aggr: null }, right: { mesh: null, aggr: null }, floor: { mesh: null, aggr: null }};
	public	Balls			:	ballinfo[];
	public	Paddles			:	{left: pdlinfo; right: pdlinfo};

	public 	name_p1			:	string = "pl1";
	public 	name_p2			:	string = "pl2";
	public 	next_p1			:	string = "pl3";
	public	next_p2			:	string = "pl4";

	public	txt_name_p1		:	BABYLON.GUI;
	public	txt_name_p2		:	BABYLON.GUI;
	public	name_p1_mesh	:	BABYLON.Mesh;
	public	name_p2_mesh	:	BABYLON.Mesh;
	public	winner_plane	:	BABYLON.Mesh;
	public	match_over		:	boolean = false;
	public	game_over		:	boolean = false;
	public	pause			:	boolean = false;
	public	ballLaunched	:	boolean = true;
	public	Intervals		:	Array<number> = [];


	public getWinnerName(winner : string)
	{
		if (winner == "p1")
			return(this.name_p1);
		return(this.name_p2);
	...
	public endGame(winner : string) : boolean
	{
	...
	public detectGoal(ball : ballinfo)
	{
		var right = false;
	...
	public createBalls() : ballinfo
	{
		this.Balls = [];
		let currentBall : ballinfo = { mesh: null, aggr: null, speed: this.startSpeed, lastTouched: null, bounces: 0};
	...
	public createPaddlesAggregate(paddle : pdlinfo) : BABYLON.PhysicsAggregate
	{
	...
	public ballBounces(ball : ballinfo)
	{
		var ballCollisionObs = ball.aggr.body.getCollisionObservable();
		var goal = ballCollisionObs.add((collisionEvent) =>
		{
	...
	public addPowerupHandler(powerupHandler : powerupHandler)
	{
		this.powerupHandler = powerupHandler;
	}

	constructor (scene : BABYLON.Scene | null, engine : BABYLON.Engine | null, hk : BABYLON.HavokPlugin | null, miscHandler : miscHandler, removeEvents : Function)
	{
		this.scene = scene;
		this.engine = engine;
	...
	public async templateCreate3D(path : string, name : string, pos : BABYLON.Vector3, rot : BABYLON.Vector3, scale : number) : Promise<BABYLON.AbstractMesh[]>
	{
		let meshes = null;
	...
	public async createModels3D()
	{
		...
		var animationWalk = new BABYLON.Animation(
		"moveAlongPath",
		"position",
		frameRate,
		BABYLON.Animation.ANIMATIONTYPE_VECTOR3,
		...
		var animation2 = new BABYLON.Animation( "moveAlongPath", "position", frameRate,
		...
		BABYLON.SceneLoader.ImportMesh(null, "assets/models3D/", "astronaut2Doc.glb", this.scene, (meshes: BABYLON.AbstractMesh[]) =>
		{
		...
		var animationWalk2 = new BABYLON.Animation(
		"moveAlongPath",
		"position",
		frameRate,
		BABYLON.Animation.ANIMATIONTYPE_VECTOR3,
		...
		var animationWalk3 = new BABYLON.Animation(
		"moveAlongPath",
		"position",
		frameRate,
		BABYLON.Animation.ANIMATIONTYPE_VECTOR3,
		...
		setTimeout((async () => {
			...
			var animationWalk4 = new BABYLON.Animation(
			"moveAlongPath",
			"position",
			frameRate,
			BABYLON.Animation.ANIMATIONTYPE_VECTOR3,
			...
			BABYLON.SceneLoader.ImportMesh(null, "assets/models3D/", "OW.glb", this.scene, (meshes: BABYLON.AbstractMesh[]) =>
			{
				var rootMesh = meshes[0];
		...
		var animationuss = new BABYLON.Animation(
		"moveAlongPath",
		"position",
		frameRateuss,
		BABYLON.Animation.ANIMATIONTYPE_VECTOR3,
		...
		var keys2 = path2.map((pos, i) => ({ frame: i * (totalFrames2 / (path2.length - 1)), value: pos }));
		animation2.setKeys(keys2);
		BABYLON.SceneLoader.ImportMesh(null, "assets/models3D/", "astronaut2DocNew.glb", this.scene, (meshes: BABYLON.AbstractMesh[]) =>
		{
			var rootMesh = meshes[0];
			...
			setTimeout((async () => {
				...
				const animationSnoopy = new BABYLON.Animation(
				"moveAlongPath",
				"position",
				frameRateSnoopy,
				BABYLON.Animation.ANIMATIONTYPE_VECTOR3,
