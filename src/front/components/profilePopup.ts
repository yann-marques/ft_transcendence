...
import { disable2fa, fillProfile, getQRCode, sendCustomization, toggleElt, toggleErrorText, updateAuthUserOnLobby, updateStatus, uploadAvatar, verifyQRCode } from "../utils.js";
...
export class profilePopup {
    ...
    constructor() {
        ...
        const twofaCheckbox = document.getElementById('checkboxTwofa') as HTMLInputElement;
        ...
        twofaCheckbox.addEventListener('click', async (e) => {
            if (!twofaCheckbox.checked) {
                ...
                toggleElt('settingsContent');
                const QRCodeEl = document.getElementById('QRCode') as HTMLImageElement;
        ...
        fileInput.addEventListener('change', () => {
            ...
            if (file && (file.type === 'image/png' || file.type === 'image/jpeg')) {
                ...
                reader.onload = async function(e) {
                    const imgBas64 = e.target.result as string;
                    avatar.src = imgBas64;
